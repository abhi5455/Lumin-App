    ...
    return (
        <View className="flex flex-col justify-center px-5 mt-5 gap-4">
            {[1, 2, 3].map((item, index) => (
                <View className="border-[1px] bg-gray-100/35 border-[#DAA520]/80 rounded-xl p-2" key={index}>
                    ...
                    <View
                        className="flex flex-row items-center justify-between border-t-[1px] border-[#DAA520]/20 mt-2 pt-2 px-3">
                        ...
                        <View className="flex flex-col justify-center items-end">
                            ...
                            <Text className="font-poppins text-md text-black">
                                2022-2026
                            </Text>
                        </View>
                    </View>
