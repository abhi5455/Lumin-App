    ...
    return (
        <View className="flex flex-col justify-center px-5 mt-5 gap-2">
            ...
            <Text className="text-lg font-poppins indent-8 text-justify px-1">
                {'\u2003'}{'\u2003'}{'\u2003'}Passionate software engineer with expertise in full-stack development, cloud architecture, and machine
                learning. Currently working at Microsoft on Azure services, focusing on scalable distributed systems and
