...
export default function About({alumnus}: { alumnus: IStudent }) {
    return (
        <>
            <View
                className="flex flex-col justify-center gap-1.5 border-[1px] bg-gray-100/35 border-[#006a63]/50 rounded-xl p-2 mx-5 mt-5">
                <View className="flex flex-row items-start w-full gap-4 mt-2">
                    ...
                    <View className="">
                        ...
                        <Text className="font-poppinsLight text-gray-600 text-[13px]">Profile overview and interests</Text>
                    </View>
                </View>
