            ...
            <View className="bg-primary flex-1">
                <View className="bg-white flex-1 justify-between rounded-t-[30px] py-5 px-5">
                    <ScrollView className="flex flex-col">
                        {/*Title*/}
                        <View className="relative flex flex-col gap-2 mb-5 mt-4">
                            <Text
                        ...
                        <View className="relative flex flex-col gap-2 mb-4">
                            <View
                                ...
                                {/*<Text className={`${content === "" ? 'hidden' : 'absolute'} top-[-10px] left-[7px] z-50 px-1 bg-white text-gray-300 font-poppinsMedium text-md ml-2`}>Tags 3/4</Text>*/}
                                <Text className="text-black font-poppinsMedium text-md">Tags 2/3</Text>
                                <View className="flex flex-row justify-start items-center gap-3 flex-wrap">
                                    <View
                                        className="flex flex-row justify-start items-center bg-primary/10 gap-1 rounded-xl py-2 px-4">
                                        <TouchableOpacity>
                                            <X size={19} color={'#006a63'}/>
                                        </TouchableOpacity>
                                        <Text className="text-[#006a63] font-poppinsMedium text-md">Experience</Text>
                                    </View>
                                    <TouchableOpacity
