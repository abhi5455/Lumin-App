...
import {BarChart3Icon, ChartNoAxesCombined, User} from "lucide-react-native";
...
export default function Analytics({company}: { company: ICompany }) {
    ...
    return (
        <View className="flex flex-col justify-center px-5 mt-5 gap-4">
            <View
                className="flex flex-col justify-center gap-1 border-[1px] bg-gray-100/40 border-[#006a63]/50 rounded-xl p-2 mt-5">
